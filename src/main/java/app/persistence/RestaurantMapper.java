...
public class RestaurantMapper {
    ...
    public static void createRestaurants() {
        Restaurant thai1 = new Restaurant("Ayut Taya","Griffenfeldsgade 39, 2200 København N" ,
        ...
        Restaurant thai2 = new Restaurant("Green Mango", "Gentofte, Søborg, Christianshavn, Brønshøj, Lyngby, Nørrebro",
        ...
        Restaurant indisk1 = new Restaurant("Hind Indisk Restaurant","Landskronagade 74, 2100 København Ø","Mandag: 16:00 - 20:00\nAlle andre dage: 13:30 - 22:00",
        ...
        Restaurant indisk2 = new Restaurant("Maharaja Indian Restaurant","Strandboulevarden 67, 2100 København Ø",
        ...
        Restaurant koreansk1 = new Restaurant("Seoul Koreansk B.B.Q","Frederiksberg, Vanløse og Nordhavn",
                "Se hjemmeside",
        ...
        Restaurant koreansk2 = new Restaurant("Ssam Korean Food Bar", "Vesterbro, Nørrebro og Fisketorvet",
                "Se hjemmeside",
        ...
        RestaurantList.addToRestaurantList(thai1);
        RestaurantList.addToRestaurantList(thai2);
        RestaurantList.addToRestaurantList(indisk1);
        RestaurantList.addToRestaurantList(indisk2);
        RestaurantList.addToRestaurantList(koreansk1);
        RestaurantList.addToRestaurantList(koreansk2);
    }
}
